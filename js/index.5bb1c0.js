...
$(function(){
r=function(){dpi=window.devicePixelRatio;var e=document.querySelector('.js1');e.setAttribute('src',(dpi>1)?'images/pas-1920.jpg':'images/pas-960.jpg');
var e=document.querySelector('.js3');e.setAttribute('src',(dpi>1)?'images/wfh-tshirt-1036.jpeg':'images/wfh-tshirt-518.jpeg');};
if(!window.HTMLPictureElement){r();}
(function(){$('a[href^="#"]:not(.allowConsent,.noConsent,.denyConsent,.removeConsent)').each(function(i,e){$(e).click(function(){var t=e.hash.length>1?$('[name="'+e.hash.slice(1)+'"]').offset().top:0;return $("html, body").animate({scrollTop:t},400),!1})})})();
ldsrc('.js5');ldsrcset('.js11 source');ldsrc('.js7');ldsrcset('.js12 source');var cs=new ConsentBanner('privacy-policy.html',undefined,0,'');cs.start(1);wl=new woolite();
wl.init();
...
wl.addAnimation($('.js9')[0], "2.20s", "0.00s", 1, 100);
wl.addAnimation($('.js10')[0], "2.20s", "0.00s", 1, 100);
wl.start();
